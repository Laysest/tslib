...
import pandas as pd
import math
from src.controller.SOTL import SOTL
from src.controller.CDRL import CDRL
from src.controller.VFB import VFB
from src.controller.IntelliLight import IntelliLight
from src.controller.LIT import LIT
from src.controller.TLCC import TLCC
from src.controller.FixedTime import FixedTime
from src.controller.MaxPressure import MaxPressure
from src.controller.CAREL import CAREL
from src.glo_vars import GloVars
from src.controller.controller import ActionType, Controller
...
class TrafficLight:
    ...
    def getRoadStructure(self):
        ...
        def getNodes(tfl_id):
            if GloVars.config['simulator'] == 'SUMO':
                center = sumolib.net.readNet('./src/traffic-sumo/%s' % GloVars.config['net']).getNode(tfl_id)
                center_node = Node()
        ...
        def getLanesArray(node, center_node):
            ...
            if GloVars.config['simulator'] == 'SUMO':
                net = sumolib.net.readNet('./src/traffic-sumo/%s' % GloVars.config['net'])
